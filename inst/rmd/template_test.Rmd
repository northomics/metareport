...
```{r}
data_table <- read.delim("../extdata/summary.txt", header = TRUE,check.names = FALSE, stringsAsFactors = FALSE)
# knit to all supported format (here we support pdf and html)
rmarkdown::render("MQ_report_summary.Rmd",output_format = "html_document", params = list(data_table =  data_table))
...
```{r}
data_table <- read.delim("../extdata/summary.txt", header = TRUE,check.names = FALSE, stringsAsFactors = FALSE)
meta_table <- read.delim("../extdata/metainfo.txt", header = TRUE,check.names = FALSE, stringsAsFactors = FALSE) 

rmarkdown::render("MQ_report_summary.Rmd",output_format = "html_document", params = list(data_table =  data_table, meta_table = meta_table ))
...
data_table <- read.delim("../extdata/peptides_report.txt", header = TRUE,check.names = FALSE, stringsAsFactors = FALSE)
rmarkdown::render("MQ_report_peptides.Rmd",output_format = "html_document", params = list(data_table =  data_table))
...
data_table  <- read.delim("../extdata/peptides_report.txt", header = TRUE,check.names = FALSE, stringsAsFactors = FALSE) # NOTE the readin options
meta_table <- read.delim("../extdata/metainfo.txt", header = TRUE, check.names = FALSE, stringsAsFactors = FALSE) # with meta file

system.time(rmarkdown::render("MQ_report_peptides.Rmd",output_format = "html_document", params = list(data_table =  data_table, meta_table = meta_table), output_file="report_peptides_summary.html"))
...
# knit to all supported format (here we support pdf and html)
rmarkdown::render("ML_report_function.Rmd",output_format = "html_document", params = list(input_datatable =  data_table))
