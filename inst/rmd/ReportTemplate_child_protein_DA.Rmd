...
if(!all(is.na(pvalues_anova))){
  df_intensity_p <- cbind(protein = rownames(pvalues_anova), 
                        pvalues_anova, 
  ...
  #df_intensity_p_filtered$protein <-  paste0("<a href='", paste0("https://unipept.ugent.be/sequences/", df_intensity_p_filtered$protein,"/"),"' target='_blank'>",df_intensity_p_filtered$protein,"</a>")
  


rhandsontable(df_intensity_p_filtered, width = 800, height = 500 ) %>%  
  hot_col("protein", renderer = htmlwidgets::JS("safeHtmlRenderer")) %>%  
  ...
  cat("no significantly changed protein found even under threshold of 0.05 ")
